...
import Logo from "../Assets/Rectangle 1 (1).png"
...
function Navbar() {
  ...
  return (
   <header className='container-xl bg-purple-600'>
...
{/* Icons */}
<div className='w-1/5 flex items-center justify-evenly text-white sm:hidden md: hidden lg:flex ' >
