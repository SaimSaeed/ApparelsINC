...
<div className='bg-purple-500 w-1/2 relative'>
  <div className='bg-fuchsia-500 w-1/5 absolute rounded text-center mt-2 ml-2'>Fashion</div>
...
<div className='bg-purple-500 w-1/2 relative '>
  <div className='bg-green w-1/5 absolute rounded text-center mt-2 ml-2'>Looks</div>
<a href='/' className='absolute top-64 left-5 bg-transparent border-fuchsia-700 px-5 py-2 border-2  text-fuchsia-700'>Read More</a>
<img src={Pic2} alt="img1" className='w-full h-full' />
</div>
<div className='bg-purple-500 w-1/2 relative '>
  <div className='bg-rose w-1/5 absolute rounded text-center mt-2 ml-2'>Beauty</div>
<a href='/' className='absolute top-64 left-5 bg-transparent border-fuchsia-700 px-5 py-2 border-2  text-fuchsia-700'>Read More</a>
<img src={Pic3} alt="img1" className='w-full h-full' />
</div>
<div className='bg-purple-500 w-1/2 relative '>
  <div className='bg-violet-600 w-1/4 absolute rounded text-center mt-2 ml-2'>Cosmetics</div>
<a href='/' className='absolute top-64 left-5 bg-transparent border-fuchsia-700 px-5 py-2 border-2  text-fuchsia-700'>Read More</a>
